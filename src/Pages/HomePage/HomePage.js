...
import { ContainerWorkspace } from "../../Components/Home/Workspace/ContainerWorkspace/ContainerWorkspace";
...
export function HomePage() {
  ...
  const initHomePage = async () => {
    ...
    dispatch(loadSortedChannelsInStore(responseListChannel.data));
